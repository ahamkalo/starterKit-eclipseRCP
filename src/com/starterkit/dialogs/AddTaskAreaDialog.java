...
public class AddTaskAreaDialog extends TitleAreaDialog {

	private Text nameText;
	private Text descriptionText;
	private ComboViewer priorityComboViewer;
	WritableList toDoTasks;
	int numberOfArchivedTasks;
	Task task;

	ControlDecoration nameTextDecorator;
	ControlDecoration descriptionTextDecorator;

	public AddTaskAreaDialog(Shell parentShell, WritableList toDoTasks,
			int numberOfArchivedTasks) {
		super(parentShell);
		this.toDoTasks = toDoTasks;
		this.numberOfArchivedTasks = numberOfArchivedTasks;
	}
	...
	private void createPriorityComboViewer(Composite container) {
		...
		priorityComboViewer
				.setSelection(new StructuredSelection(priorities[0]));
	}
	...
	private void addNewTask() {
		Long id = new Long(toDoTasks.size() + numberOfArchivedTasks + 1);
		...
		task = new Task(id, name, description, priority);
